...
* Now, you can start to play with [face.evoLVe](#Introduction) and run ```train.py```. User friendly information will popped out on your terminal:
  ...
  * About number of training classes:
    ...
    <img src="https://github.com/ZhaoJ9014/face.evoLVe.PyTorch/blob/master/disp/Fig5.png" width="500px"/>
  ...
  * About head details:
    ...
    <img src="https://github.com/ZhaoJ9014/face.evoLVe.PyTorch/blob/master/disp/Fig7.png" width="500px"/>
  
  * About loss details:
  
    <img src="https://github.com/ZhaoJ9014/face.evoLVe.PyTorch/blob/master/disp/Fig8.png" width="500px"/>
  
  * About optimizer details:
  
    <img src="https://github.com/ZhaoJ9014/face.evoLVe.PyTorch/blob/master/disp/Fig9.png" width="500px"/>
