...
``` 
* Face alignment API (perform face detection, landmark localization and alignment with affine transformations on a whole database folder and store the aligned results to a new folder with the same directory structure): ```face_align.py```. 
