...
|Database|Version|\#Identity|\#Image|\#Frame|\#Video|Download Link|Remark|
|:---:|:----:|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
...
|[CASIA-WebFace](https://arxiv.org/pdf/1411.7923.pdf)|Clean|10,575|455,594|-|-|[Google Drive](https://drive.google.com/file/d/1wJC2aPA4AC0rI-tAL2BFs2M8vfcpX-w6/view?usp=sharing), [Baidu Drive](https://pan.baidu.com/s/1x_VJlG9WV1OdrrJ7ARUZQw)|```unzip casia-maxpy-clean.zip    cd casia-maxpy-clean    zip -F CASIA-maxpy-clean.zip --out CASIA-maxpy-clean_fix.zip    unzip CASIA-maxpy-clean_fix.zip```|
...
|[CFP](http://www.cfpw.io/paper.pdf)|Raw|500|7,000|-|-| ||
