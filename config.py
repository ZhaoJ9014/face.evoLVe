...
configurations = {
    1: dict(
        ...
        LR = 0.1, # initial LR
        NUM_EPOCH_WARM_UP = 5, # use the firt NUM_EPOCH_WARM_UP (5 epochs) to warm up
        NUM_EPOCH = 20 + 5, # total epoch number
        WEIGHT_DECAY = 5e-4,
        MOMENTUM = 0.9,
        STAGES = [12 + 5, 15 + 5, 18 + 5], # epoch stages to decay learning rate
